...
Band.create(name: "Lucked Out", genre: "Post-hardcore", city: "Jackson", state: "New Jersey")
Band.create(name: "Dan's Basement", genre: "Pop punk", city: "Lake Nowak", state: "New Jersey")
